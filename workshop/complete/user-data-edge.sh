...
cp -av /root/immersive-media-refarch/workshop/complete/edge/nginx/nginx.conf /etc/nginx/
cp -av /root/immersive-media-refarch/workshop/complete/edge/awslogs/awslogs.conf /etc/awslogs/
cp -av /root/immersive-media-refarch/workshop/complete/edge/init/spot-instance-termination-notice-handler.conf /etc/init/spot-instance-termination-notice-handler.conf
cp -av /root/immersive-media-refarch/workshop/complete/edge/bin/spot-instance-termination-notice-handler.sh /usr/local/bin/
